...
const Navbar = () => {
  ...
  return (
    <>
        ...
        <div className="uc-navbar container mx-auto min-h-[4rem] flex justify-between items-center px-4 sm:px-6 md:px-10 lg:px-12 xl:justify-around pt-5 relative">
          ...
          <div className="uc-navbar-right flex items-center gap-3 sm:gap-4 lg:gap-7">
            ...
            <button
              ...
              className="hidden lg:flex text-sm md:text-base font-semibold
                         bg-[#12715B] text-white rounded-lg py-2 md:py-3 px-3
                         hover:bg-opacity-90"
            >
              Start free trial
            </button>
      ...
      {/* Callback form that appears below navbar when button is clicked */}
      {showCallback && (
