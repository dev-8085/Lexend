  ...
  return (
    <div className="relative" style={{ backgroundColor: '#F6EEE9' }}>
      <div className="absolute top-[12%] right-[15%] transform rotate-45 reveal hidden lg:block">
        <img alt="star-2" loading="lazy" width="69" height="95" className="w-[24px] text-gray-900 dark:text-white" src={star2} />
      </div>

      <div className="absolute top-[15%] left-[35%] transform -rotate-12 reveal hidden lg:block">
        <img alt="icon-trophy-dark" loading="lazy" width="100" height="100" className="w-[48px] xl:w-[56px] hidden dark:block" src={Trophy} />
      </div>

      <div className="absolute bottom-[2%] left-[30%] transform -translate-y-1/2 reveal hidden lg:block">
        <img alt="icon-globe-dark" loading="lazy" width="100" height="100" className="w-[40px] xl:w-[48px] hidden dark:block" src={global} />
      </div>

      <div className="absolute rotate-45 reveal hidden lg:block" style={{ bottom: '20%', right: '8%' }}>
        <img alt="icon-crown-dark" loading="lazy" width={100} height={100} className="w-[48px] xl:w-[56px] hidden dark:block" style={{ color: 'transparent', transform: 'translateX(0px) translateY(0px)', opacity: 1 }} src={Crown} />
      </div>

      <div className="absolute -translate-y-1/2 rotate-45 -ms-3 reveal hidden lg:block" style={{ top: '45%' }}>
        <img alt="icon-location-dark" loading="lazy" width={100} height={100} className="w-[48px] xl:w-[56px] hidden dark:block" style={{ color: 'transparent', transform: 'translateX(0px) translateY(0px)', opacity: 1 }} src={location} />
      </div>

      <div className="absolute -rotate-12 -me-3 top-[38%] translate-y-1/2 reveal hidden lg:block">
        <img src={chat} alt="icon-chat" width={100} height={100} className="w-12 xl:w-14 block dark:hidden" style={{ color: 'transparent', transform: 'translateX(0px) translateY(0px)', opacity: 1 }} />
        <img src={chat} alt="icon-chat-dark reveal" width={100} height={100} className="w-12 xl:w-14 hidden dark:block" style={{ color: 'transparent', transform: 'translateX(0px) translateY(0.0097341px)', opacity: 0.999797 }} />
      </div>

      <div className="absolute top-[60%] right-[48%] -translate-y-1/2 -rotate-12 reveal hidden lg:block">
        <img alt="icon-diamond" loading="lazy" width="100" height="100" decoding="async" className="w-[48px] xl:w-[56px] block dark:hidden" style={{ color: 'transparent', transform: 'translateX(0px) translateY(0px)', opacity: 1 }} src={diamond} />
        <img alt="icon-diamond-dark" loading="lazy" width="100" height="100" decoding="async" className="w-[48px] xl:w-[56px] hidden dark:block" style={{ color: 'transparent', transform: 'translateX(0px) translateY(0px)', opacity: 1 }} src={diamondDark} />
      </div>
